...
export default {
    ...
    var data = {
      ...
      options: {
        ...
        customBackend: {
          ...
          "now-subconverter2.49470488.vercel.app (kumo测试）": "https://now-subconverter2.49470488.vercel.app/sub?",
        ...
        backendOptions: [
          ...
          { value: "https://now-subconverter2.49470488.vercel.app/sub?" },
  ...
  mounted() {
    ...
    this.form.customBackend = "https://now-subconverter2.49470488.vercel.app/sub?";
